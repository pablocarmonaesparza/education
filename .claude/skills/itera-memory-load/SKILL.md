...
- Memorias individuales: `docs/memory/<tipo>_<slug>.md` (frontmatter + body).
...
- Si la sesión dura mucho y tomamos decisiones nuevas, sugiere correr `/itera-memory-save` antes de cerrar.
