...
export default function OnboardingTeamPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.error ?? "Could not create the team.");
  ...
  return (
    <>
      <OnboardingNav progress={{ total: 5, current: 1, ariaLabel: "Step 2 of 5" }} />
      <main className="surface-canvas min-h-[calc(100vh-5rem)] flex items-center justify-center px-6 py-12">
        ...
        >
          <h1 className="display display-tight ts-title-1 sm:ts-display leading-[1.1] text-[var(--text-primary)]">
            Which team do you want to assess first?
          </h1>

          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            <AppleSelect
              placeholder="Function"
              aria-label="Team function"
