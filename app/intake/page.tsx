      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-20 pb-12">
        ...
        {!loading ? (
          <>
            ...
            <div className="mb-8">
              <div className="relative bg-white dark:bg-gray-950 rounded-2xl p-6 border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus-within:border-[#1472FF] transition-all duration-300">
