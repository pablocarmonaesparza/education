            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="group flex items-center">
                  ...
                  <span className={`text-sm font-medium mr-2 opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 ${
                    currentVideo.isCompleted ? 'text-green-500' : 'text-gray-500 dark:text-gray-400'
                  }`}>
                    Completado
                  </span>
                  <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                      currentVideo.isCompleted
                        ? 'bg-green-500 text-white group-hover:bg-gray-200 dark:group-hover:bg-gray-700 group-hover:text-green-500'
                        : 'border-2 border-gray-300 dark:border-gray-600 text-gray-300 dark:text-gray-600 group-hover:border-green-500 group-hover:text-green-500'
                    }`}
                  >
                ...
                <div className="group flex items-center">
                  {/* Label - appears on hover */}
                  <span className={`text-sm font-medium mr-2 opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 ${
                    favorites.has(currentVideo.id) ? 'text-[#1472FF]' : 'text-gray-500 dark:text-gray-400'
                  }`}>
                    Favorito
                  </span>
                  <button
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                      favorites.has(currentVideo.id)
                        ? 'bg-[#1472FF] text-white group-hover:bg-gray-200 dark:group-hover:bg-gray-700 group-hover:text-[#1472FF]'
                        : 'border-2 border-gray-300 dark:border-gray-600 text-gray-300 dark:text-gray-600 group-hover:border-[#1472FF] group-hover:text-[#1472FF]'
                    }`}
                  >
                    <svg 
                      className="w-5 h-5" 
