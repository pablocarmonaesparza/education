      ...
      <div className="mb-8">
        <div className="relative">
          <input
            ...
            className="w-full px-6 py-4 pl-14 rounded-2xl border-2 border-gray-200 dark:border-gray-700 focus:border-[#1472FF] focus:ring-2 focus:ring-[#1472FF]/20 outline-none transition-all text-gray-900 dark:text-white bg-white dark:bg-gray-950 placeholder-gray-400"
          />
          <svg
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-bold whitespace-nowrap transition-all duration-150 ${
                selectedCategory === category.id
                  ...
                  : 'bg-white dark:bg-gray-950 text-[#4b4b4b] dark:text-gray-300 border-2 border-gray-200 dark:border-gray-700 hover:border-[#1472FF]'
              }`}
            >
