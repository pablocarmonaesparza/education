              ...
              {isEditing ? (
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"
                  >
                    Cancelar
                  </button>
                </div>
        ...
        <div id="configuracion" className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <div className="p-6 flex items-center justify-between">
              ...
              <button className="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 text-sm">
                Cambiar plan
              </button>
            </div>
