  ...
  return (
    <div className="min-h-full bg-transparent">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        {/* Profile Card */}
        <div className="bg-white dark:bg-gray-950 rounded-2xl border border-gray-200 dark:border-black overflow-hidden mb-6">
          {/* Avatar Section */}
              ...
              {isEditing ? (
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-xl border border-gray-200 dark:border-black dark:bg-gray-950 dark:text-white focus:border-[#1472FF] focus:outline-none"
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl border border-gray-200 dark:border-black text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"
                  >
                    Cancelar
                  </button>
                </div>
        ...
        <div id="configuracion" className="bg-white dark:bg-gray-950 rounded-2xl border border-gray-200 dark:border-black overflow-hidden mb-6">
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <div className="p-6 flex items-center justify-between">
              ...
              <button className="px-4 py-2 rounded-xl border border-gray-200 dark:border-black text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 text-sm">
                Cambiar plan
              </button>
            </div>
