...
export default function DemoVideoPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Demo Header */}
      <div className="bg-gradient-to-r from-primary to-primary-dark text-white py-3 px-4 text-center">
        <p className="text-sm">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="mb-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-gradient-to-r from-primary to-primary-dark h-2 rounded-full" style={{ width: '0%' }}></div>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 space-y-3">
              ...
              <button className="w-full bg-gradient-to-r from-primary to-primary-dark text-white px-4 py-3 rounded-lg font-semibold hover:from-primary-dark hover:to-primary transition-all">
                Siguiente Video →
              </button>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <div className="mt-12 bg-white rounded-lg shadow-md p-8 border border-primary/20 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              href="/auth/signup"
              className="bg-gradient-to-r from-primary to-primary-dark text-white px-8 py-3 rounded-lg font-semibold hover:from-primary-dark hover:to-primary transition-all"
            >
              Crear Cuenta Gratis
            </Link>
            <Link
