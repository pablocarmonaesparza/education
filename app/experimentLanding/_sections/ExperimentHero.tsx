...
/**
 * Hero experimental — inspirado en el "hero + video-grid + hero-subhead"
 * de webflow, reinterpretado con tipografía Itera y una palabra que rota.
 */
