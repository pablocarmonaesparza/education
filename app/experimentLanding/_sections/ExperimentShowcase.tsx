...
/**
 * Showcase de "cursos destacados" — inspirado en el grid de cases
 * del Webflow Template (photo grid + categoría + número), reconstruido
 * con CompositeCard del design system Itera.
 */
