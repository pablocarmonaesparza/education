...
/**
 * Bento grid experimental — muestra "qué puedes construir" con itera.
 * Cada celda usa <Card> del DS y animaciones on-scroll con framer-motion.
 * Inspirado en los grids de servicios del Webflow Template,
 * pero con tokens y profundidad de Itera.
 */
