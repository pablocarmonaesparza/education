            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-shrink-0 px-6 pb-8 mb-safe">
                <Link
                  href="/auth/signup"
                  onClick={() => setMobileMenuOpen(false)}
                  className={`block py-4 text-center font-bold text-lg uppercase tracking-wide rounded-2xl bg-primary ${depth.bottom} border-primary-dark text-white`}
                >
                  Comenzar
                </Link>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  <Link
                    href="/auth/signup"
                    onClick={() => setMobileMenuOpen(false)}
                    className={`block py-3 px-4 text-center font-bold uppercase tracking-wide rounded-2xl transition-all bg-primary ${depth.bottom} border-primary-dark text-white hover:bg-primary-dark`}
                  >
                    Comenzar
                  </Link>
                </motion.div>
