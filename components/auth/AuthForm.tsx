...
export default function AuthForm({ mode }: AuthFormProps) {
  ...
  return (
    <div className="w-full max-w-md">
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl p-8">
        {/* Header */}
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#4b4b4b] dark:text-white tracking-tight mb-2">
