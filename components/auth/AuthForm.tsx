    ...
    <div className="w-full max-w-md">
      <div className="bg-white dark:bg-gray-950 rounded-2xl p-8 md:p-10 border-2 border-gray-200 dark:border-black">
        ...
        <button
          ...
          disabled={loading || oauthLoading}
          className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-950 border-2 border-b-4 border-gray-200 dark:border-black text-gray-700 dark:text-gray-300 py-4 rounded-2xl font-bold hover:bg-gray-50 dark:hover:bg-gray-700 active:border-b-2 active:mt-[2px] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {oauthLoading ? (
