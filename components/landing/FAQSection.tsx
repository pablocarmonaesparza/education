            ...
            {faqs.map((faq, index) => (
              <div 
                ...
                className={`rounded-2xl transition-all duration-150 ${
                  openIndex === index
                    ? "bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 border-b-4 border-b-gray-300 dark:border-b-gray-950"
                    : "bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 border-b-4 border-b-gray-300 dark:border-b-gray-950 hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-[1.02] active:scale-[0.98]"
                }`}
              >
                <button
