...
export default function NewHeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 pb-20">
                    ...
                    <motion.button
                      ...
                      className={`px-3 py-2 rounded-xl text-xs font-medium border-2 border-b-4 transition-all duration-150 flex items-center gap-1.5 ${
                        selectedOption === option.id
                          ...
                          : "bg-gray-100 dark:bg-gray-950 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-black border-b-gray-300 dark:border-b-black hover:bg-gray-200 dark:hover:bg-gray-800"
      ...
      <AnimatePresence mode="wait">
        {showAuthModal && (
          ...
          >
            ...
            >
              {/* Auth Form */}
              <div className="bg-white dark:bg-gray-950 rounded-2xl overflow-hidden border border-gray-200 dark:border-black relative">
