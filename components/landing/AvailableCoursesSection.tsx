    ...
    >
      {courses.map((course, index) => (
        <button
          ...
          className="flex-shrink-0 w-[200px] md:w-[240px] lg:w-[280px] bg-[#0a1e3d] rounded-2xl p-4 md:p-5 border-2 border-[#030712] border-b-4 border-b-[#030712] text-left cursor-pointer transition-all duration-200"
        >
          {/* Icon */}
