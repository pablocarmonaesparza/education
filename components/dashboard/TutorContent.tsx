          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {messages.length === 0 && (
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 bg-white dark:bg-gray-950 rounded-2xl p-4 border border-gray-100 dark:border-gray-700">
              ...
              >
                ...
                <div className={`flex-1 rounded-2xl p-4 ${
                  msg.role === 'user'
                    ...
                    : 'bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white mr-12'
                }`}>
            ...
            {isSending && (
              <div className="flex items-start gap-3">
                ...
                <div className="bg-white dark:bg-gray-950 rounded-2xl p-4 border border-gray-100 dark:border-gray-700">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
          <div className="max-w-3xl mx-auto flex items-end gap-2">
            <textarea
              ...
              className="flex-1 resize-none border-2 border-gray-200 dark:border-gray-700 rounded-2xl px-4 py-4 bg-white dark:bg-gray-950 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1472FF] focus:border-transparent"
              rows={1}
              disabled={isSending}
            />
            <button
