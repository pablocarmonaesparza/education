...
export default function CourseCard({
  ...
  return (
    <Link
      ...
      className="block bg-white dark:bg-gray-950 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-gray-200 dark:border-black hover:border-[#1472FF] dark:hover:border-[#1472FF] group"
    >
      {/* Header */}
