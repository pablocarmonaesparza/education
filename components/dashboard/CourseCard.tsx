        ...
        <div className="relative bg-primary p-6">
          ...
          {progress > 0 && (
            <div className="absolute top-4 right-4">
              <Tag variant="outline" className="font-bold border-b-2 border-gray-200">
                {progress}%
              </Tag>
            </div>
          )}
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between text-sm text-ink-muted dark:text-gray-400">
            <div className="flex items-center gap-1">
              ...
              <span className="font-medium">{videoCount} lecciones</span>
            </div>
            <div className="flex items-center gap-1">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {progress > 0 && (
            <div className="mt-4">
              <ProgressBar value={progress} size="md" color="primary" durationMs={500} />
            </div>
          )}
        </div>
      </Card>
