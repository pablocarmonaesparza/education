      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border-2 border-gray-200 dark:border-gray-950 overflow-hidden hover:shadow-md transition-shadow">
              <div className="p-6 sm:p-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-4 sm:p-6 mb-6 border-2 border-gray-100 dark:border-gray-950 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
