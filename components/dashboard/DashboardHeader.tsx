        ...
        >
          ...
          {showSettingsMenu && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border-2 border-gray-200 dark:border-gray-700 py-2 z-20">
                <button
                  onClick={() => {
        ...
        <div className="relative">
          ...
          {showProfileMenu && (
            <>
              ...
              />
              <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border-2 border-gray-200 dark:border-gray-700 py-2 z-20">
