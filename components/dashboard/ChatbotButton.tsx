    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      {isExpanded && (
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 mb-2 w-72 border-2 border-b-4 border-gray-200 dark:border-gray-950 border-b-gray-300 dark:border-b-gray-950 animate-in fade-in slide-in-from-bottom-4 duration-200">
          ...
          <button
            ...
            className="w-full py-2 px-4 rounded-xl font-bold text-sm uppercase tracking-wide bg-[#1472FF] text-white border-2 border-b-4 border-[#0E5FCC] hover:bg-[#1265e0] active:border-b-2 active:mt-[2px] transition-all"
          >
            Abrir Chat Completo
          </button>
        </div>
      ...
      <button
        ...
        className={`
          ...
          hover:bg-[#1265e0] active:border-b-2 active:mt-[2px] transition-all duration-150
