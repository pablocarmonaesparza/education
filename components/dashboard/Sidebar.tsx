      ...
      {lessonNav ? (
        <nav className="flex-1 px-3 py-4 overflow-y-auto">
          <div className="px-2 pb-3 mb-2 border-b border-gray-200 dark:border-gray-900">
            <h2 className="text-lg font-bold lowercase text-ink dark:text-gray-200 truncate">
              {lessonNav.phaseName}
            </h2>
          </div>
                  ...
                  <button
                    ...
                    className={[
                      ...
                      isActive
                        ...
                        : l.isCompleted
                          ? 'text-ink dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
                          : 'text-ink dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800',
                    ].join(' ')}
                  >
                    <span
                      className={[
                        ...
                        isActive
                          ...
                          : l.isCompleted
                            ...
                            : 'bg-gray-200 dark:bg-gray-800 text-ink-muted dark:text-gray-400',
                      ].join(' ')}
                    >
                      {l.isCompleted ? (
            ...
            <>
              ...
              <CardFlat className="absolute bottom-full mb-2 left-0 right-0 py-2 z-20 shadow-lg">
                <Link
                  ...
                  className="w-full text-left px-4 py-2.5 text-sm font-medium text-ink dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-2"
                >
