...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen bg-white dark:bg-[#0a1e3d] flex flex-col z-50 w-64">
      {/* Logo */}
        ...
        <div className="relative">
          ...
          {showProfileMenu && (
            <>
              ...
              />
              <div className="absolute bottom-full mb-2 left-0 right-0 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 py-2 z-20 shadow-lg">
