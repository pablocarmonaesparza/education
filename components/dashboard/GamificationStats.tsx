    ...
    <CardFlat className="shadow-lg overflow-hidden">
      ...
      <div className="p-4 grid grid-cols-2 gap-4">
        ...
        <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4 border border-red-100 dark:border-red-800">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-ink-muted dark:text-gray-400">Racha</span>
          </div>
        ...
        <div className="bg-primary/10 rounded-lg p-4 border border-primary/20">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-2xl">🎯</span>
            <span className="text-sm font-medium text-ink-muted dark:text-gray-400">Meta Semanal</span>
          </div>
      ...
      <div className="px-4 pb-4">
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
          <p className="text-xs text-ink-muted dark:text-gray-400 font-medium mb-2">Gana XP:</p>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="flex items-center gap-1">
              <span className="text-completado">+10</span>
              <span className="text-ink-muted dark:text-gray-400">por video</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-completado">+50</span>
              <span className="text-ink-muted dark:text-gray-400">por fase</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-completado">+25</span>
              <span className="text-ink-muted dark:text-gray-400">por checkpoint</span>
            </div>
            <div className="flex items-center gap-1">
              <span className="text-completado">+100</span>
              <span className="text-ink-muted dark:text-gray-400">racha 7 días</span>
            </div>
          </div>
        </div>
      </div>
