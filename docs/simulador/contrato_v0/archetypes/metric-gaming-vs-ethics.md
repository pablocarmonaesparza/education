---
type: archetype
slug: metric-gaming-vs-ethics
version: 1.0.0-draft
tension: Cumplir métrica vs ética del proceso
inspiration_structural: VW Dieselgate (2015)
date: 2026-05-19
authors: [claude]
---

# Arquetipo: metric-gaming-vs-ethics

## Tensión arquetípica
Cumplir métrica vs ética del proceso

## Inspiración estructural (NO IP, solo estructura narrativa)
VW Dieselgate (2015)

## Adaptación a contexto IA
Equipo descubre que usar IA para 'optimizar' un reporte produce mejores métricas pero distorsiona la realidad. ¿Cumplir métrica del manager o reportar la distorsión?
...
metric-gaming-vs-ethics@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
