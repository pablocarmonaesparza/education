---
type: archetype
slug: cannibalize-or-preserve
version: 1.0.0-draft
tension: Reemplazar workflow current vs status quo
inspiration_structural: Netflix DVD → streaming pivot
date: 2026-05-19
authors: [claude]
---

# Arquetipo: cannibalize-or-preserve

## Tensión arquetípica
Reemplazar workflow current vs status quo

## Inspiración estructural (NO IP, solo estructura narrativa)
Netflix DVD → streaming pivot

## Adaptación a contexto IA
Workflow legacy funciona pero IA agentic podría replazarlo end-to-end. ¿Proponer cannibalizar el current process o coexistir indefinidamente?
...
cannibalize-or-preserve@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
