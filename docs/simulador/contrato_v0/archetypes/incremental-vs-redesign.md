---
type: archetype
slug: incremental-vs-redesign
version: 1.0.0-draft
tension: Cambio piecemeal vs rediseño workflow
inspiration_structural: Sears digital decline (2010s)
date: 2026-05-19
authors: [claude]
---

# Arquetipo: incremental-vs-redesign

## Tensión arquetípica
Cambio piecemeal vs rediseño workflow

## Inspiración estructural (NO IP, solo estructura narrativa)
Sears digital decline (2010s)

## Adaptación a contexto IA
Equipo agrega IA a workflow legacy paso a paso, generando complejidad. ¿Continuar parchando o proponer rediseño completo del workflow con IA como capa primaria?
...
incremental-vs-redesign@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
