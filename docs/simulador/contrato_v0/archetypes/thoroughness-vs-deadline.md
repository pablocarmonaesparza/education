---
type: archetype
slug: thoroughness-vs-deadline
version: 1.0.0-draft
tension: Rigor analítico vs deadline del cliente
inspiration_structural: Consulting 'by Monday' classic
date: 2026-05-19
authors: [claude]
---

# Arquetipo: thoroughness-vs-deadline

## Tensión arquetípica
Rigor analítico vs deadline del cliente

## Inspiración estructural (NO IP, solo estructura narrativa)
Consulting 'by Monday' classic

## Adaptación a contexto IA
Manager pide reporte/análisis para mañana usando IA. ¿Entregar con caveat de validación pendiente, retrasar para validar completo, o entregar y validar in-the-loop?
...
thoroughness-vs-deadline@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
