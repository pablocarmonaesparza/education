---
type: archetype
slug: crisis-velocity-vs-precision
version: 1.0.0-draft
tension: Velocidad de respuesta vs precisión
inspiration_structural: Tylenol crisis J&J 1982 — response timing
date: 2026-05-19
authors: [claude]
---

# Arquetipo: crisis-velocity-vs-precision

## Tensión arquetípica
Velocidad de respuesta vs precisión

## Inspiración estructural (NO IP, solo estructura narrativa)
Tylenol crisis J&J 1982 — response timing

## Adaptación a contexto IA
Crisis pública en redes; manager pide usar IA para draft de respuesta inmediato. ¿Velocidad sacrifica exactitud factual? ¿Validación pierde la ventana?
...
crisis-velocity-vs-precision@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
