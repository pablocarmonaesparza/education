---
type: archetype
slug: defer-expertise-vs-authority
version: 1.0.0-draft
tension: Defer a expertise vs presión de autoridad
inspiration_structural: Cuban Missile Crisis ExComm dynamics
date: 2026-05-19
authors: [claude]
---

# Arquetipo: defer-expertise-vs-authority

## Tensión arquetípica
Defer a expertise vs presión de autoridad

## Inspiración estructural (NO IP, solo estructura narrativa)
Cuban Missile Crisis ExComm dynamics

## Adaptación a contexto IA
Empleado tiene contexto técnico; manager pide acción que el empleado considera riesgosa. ¿Defer a autoridad, objetar con alternativa, escalar lateralmente?
...
defer-expertise-vs-authority@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
