---
type: archetype
slug: entry-without-plan
version: 1.0.0-draft
tension: Estrategia formal vs descubrimiento accidental
inspiration_structural: Honda en EEUU (Pascale 1984)
date: 2026-05-19
authors: [claude]
---

# Arquetipo: entry-without-plan

## Tensión arquetípica
Estrategia formal vs descubrimiento accidental

## Inspiración estructural (NO IP, solo estructura narrativa)
Honda en EEUU (Pascale 1984)

## Adaptación a contexto IA
Equipo entra a usar IA sin política clara; descubre value de forma orgánica. ¿Formalizar la práctica antes de que escale, o dejar crecer informal y observar qué emerge?
...
entry-without-plan@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
