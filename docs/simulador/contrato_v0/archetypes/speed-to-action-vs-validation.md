---
type: archetype
slug: speed-to-action-vs-validation
version: 1.0.0-draft
tension: Acción rápida vs validación rigurosa
inspiration_structural: Toyota Way / Lean principles
date: 2026-05-19
authors: [claude]
---

# Arquetipo: speed-to-action-vs-validation

## Tensión arquetípica
Acción rápida vs validación rigurosa

## Inspiración estructural (NO IP, solo estructura narrativa)
Toyota Way / Lean principles

## Adaptación a contexto IA
Manager presiona por entregar campaign/feature/report rápido usando IA. ¿Sacrificar validación o defenderla con costo de timeline?
...
speed-to-action-vs-validation@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
