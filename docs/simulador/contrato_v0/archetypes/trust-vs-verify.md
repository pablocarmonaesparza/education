---
type: archetype
slug: trust-vs-verify
version: 1.0.0-draft
tension: Confiar en sistema vs verificar
inspiration_structural: Boeing MCAS / 737 MAX (2018-2019)
date: 2026-05-19
authors: [claude]
---

# Arquetipo: trust-vs-verify

## Tensión arquetípica
Confiar en sistema vs verificar

## Inspiración estructural (NO IP, solo estructura narrativa)
Boeing MCAS / 737 MAX (2018-2019)

## Adaptación a contexto IA
Output de IA parece autoritativo (cifras, recomendaciones). ¿Verificar contra fuente independiente o aceptar bajo presión de tiempo? Reagan principle aplicado: trust, but verify.
...
trust-vs-verify@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
