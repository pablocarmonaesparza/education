---
type: archetype
slug: incentives-vs-risk
version: 1.0.0-draft
tension: Incentivar adopción vs uso descontrolado
inspiration_structural: Lincoln Electric piece-rate system
date: 2026-05-19
authors: [claude]
---

# Arquetipo: incentives-vs-risk

## Tensión arquetípica
Incentivar adopción vs uso descontrolado

## Inspiración estructural (NO IP, solo estructura narrativa)
Lincoln Electric piece-rate system

## Adaptación a contexto IA
Manager incentiva uso de IA con bonus de productividad; algunos empleados maximizan métrica generando outputs sin validación, o usando datos sensibles para ahorrar tiempo.
...
incentives-vs-risk@1.0.0-draft. Patch cuando refinas copy. Minor cuando agregas dimensiones evaluables. Major cuando cambia la tensión central.
