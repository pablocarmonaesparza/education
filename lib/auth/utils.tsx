/**
 * Shared auth utilities — error translation, config check, Google icon.
 */
...
export function getOAuthRedirectUrl(from: 'login' | 'signup'): string {
  return `${window.location.origin}/auth/callback?from=${from}`;
}
